...
namespace Tutorial.Global.Exceptions
{
    ...
    /// </summary>
    public class AuthenticatedUserRoleException : TutorialApplicationException
    {
        ...
        public AuthenticatedUserRoleException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        public AuthenticatedUserRoleException(string message) : base(message)
        {
        }
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when message is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">Thrown when message is the empty string.</exception>
        public AuthenticatedUserRoleException(string message, int statusCode, Exception inner) : base(message, statusCode, inner)
        {
        }
