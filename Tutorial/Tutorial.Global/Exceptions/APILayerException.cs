...
{
    /// <summary>
    /// API layer of application throws this exception
    /// </summary>
    public class APILayerException : TutorialApplicationException
    {
        ...
        public APILayerException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        /// <exception cref="System.ArgumentNullException">Thrown when message is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">Thrown when message is the empty string.</exception>
        public APILayerException(string message, int statusCode, Exception inner) : base(message, statusCode, inner)
        {
        }
